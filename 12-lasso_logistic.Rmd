...
How is one row of information computed? Carefully describe (in words) the CV process for a single iteration to estimate each of CV `roc_auc` and `accuracy` (overall accuracy). Use a generic confusion matrix (filled with TP, TN, FP, FN instead of hard numbers) to illustrate the underlying computations.
