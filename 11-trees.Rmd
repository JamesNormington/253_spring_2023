...
- `cost_complexity`: complexity parameter. Any split that does not increase node purity by `cp` is not attempted.
...
- Try a sequence of 100 `cost_complexity` values from 0.00001 to 0.1.
